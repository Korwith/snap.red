// imported from the following: https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/leaflet/index.d.ts
...
declare namespace geojson {
    ...
    export interface Point extends Geometry { type: "Point"; coordinates: number[]; }
    export interface MultiPoint extends Geometry { type: "MultiPoint"; coordinates: number[][]; }
    export interface LineString extends Geometry { type: "LineString"; coordinates: number[][]; }
    export interface MultiLineString extends Geometry { type: "MultiLineString"; coordinates: number[][][]; }
    export interface Polygon extends Geometry { type: "Polygon"; coordinates: number[][][]; }
    export interface MultiPolygon extends Geometry { type: "MultiPolygon"; coordinates: number[][][][]; }
    export interface GeometryCollection extends Geometry { type: "GeometryCollection"; geometries: Geometry[]; }
